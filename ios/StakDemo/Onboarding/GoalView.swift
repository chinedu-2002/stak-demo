	...
	var body: some View {
		MatrixQuizView(
			...
			options: [
				...
				MatrixOption(title: "Find my first stocks", subtitle: "I want to understand what to watch", icon: "GoalSearch", iconSize: 26.49),
				MatrixOption(title: "Just exploring", subtitle: "Curious, no plan yet", icon: "GoalExplore")
			],
			onBack: onBack,
